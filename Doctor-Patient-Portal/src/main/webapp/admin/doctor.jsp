...
/* Blurred Background Image (Matches previous style) */
body::before {
	content: "";
	position: fixed;
	top: 0;
	...
	/* Strong blur and slightly brighter */
								...
								<div class="row g-3">
									<div class="col-12">
										<label class="form-label">Full Name</label> <input
											...
											class="form-control" required pattern="^[A-Za-z\s]{2,40}$"
											maxlength="40"
									...
									<div class="col-md-6 col-12">
										<label class="form-label">Date of Birth</label> <input
											required id="dateOfBirth" name="dateOfBirth" type="date"
											class="form-control">
									...
									<div class="col-12 mt-4">
										<button type="submit" class="btn btn-primary w-100">Register
											Doctor</button>
									</div>
								</div>
							</form>
